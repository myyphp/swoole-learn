...
class Sms
{
     ...
     */
    public static function sendSms($phoneNumber, $smsSign, $smsTemp, array $params = []) {
        ...
        /*
         * object(stdClass)#1285 (3) {
              ["Message"]=>
              string(38) "模板不合法(不存在或被拉黑)"
              ["RequestId"]=>
              string(36) "A05D6D2C-9724-4401-A6DD-6A37BE6BDE85"
              ["Code"]=>
              string(24) "isv.SMS_TEMPLATE_ILLEGAL"
            }

        //成功状态的返回
        object(stdClass)#1285 (4) {
            ["Message"]=>
            string(2) "OK"
            ["RequestId"]=>
            string(36) "B4B5D4F4-EF6A-4EFD-9569-11B038485CCD"
            ["BizId"]=>
            string(20) "812218143393203417^0"
            ["Code"]=>
            string(2) "OK"
            }
